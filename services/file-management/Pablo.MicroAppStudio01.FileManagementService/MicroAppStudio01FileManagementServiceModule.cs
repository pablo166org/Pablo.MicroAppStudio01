...
public class MicroAppStudio01FileManagementServiceModule : AbpModule
{
    ...
    private void ConfigureObjectMapper()
    {
        ...
        {
            options.AddMaps<MicroAppStudio01FileManagementServiceModule>(validate: true);
        });
    }
    ...
    private void ConfigureAutoControllers()
    {
        Configure<AbpAspNetCoreMvcOptions>(options =>
        {
            options
                ...
                .Create(typeof(MicroAppStudio01FileManagementServiceModule).Assembly, opts =>
                {
                    opts.RemoteServiceName = "FileManagementService";
                    opts.RootPath = "filemanagementservice";
