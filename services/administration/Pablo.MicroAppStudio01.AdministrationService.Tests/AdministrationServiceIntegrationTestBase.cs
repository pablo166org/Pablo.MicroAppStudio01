...
public abstract class AdministrationServiceIntegrationTestBase : AbpAspNetCoreIntegratedTestBase<AdministrationServiceTestsModule>
{
    ...
    {
        var assemblyDirectoryPath = Path.GetDirectoryName(typeof(MicroAppStudio01AdministrationServiceModule).Assembly.Location);
        if (assemblyDirectoryPath == null)
        {
            throw new Exception($"Could not find location of {typeof(MicroAppStudio01AdministrationServiceModule).Assembly.FullName} assembly!");
        }
