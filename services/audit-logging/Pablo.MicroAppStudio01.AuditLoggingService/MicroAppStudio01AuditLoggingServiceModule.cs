...
public class MicroAppStudio01AuditLoggingServiceModule : AbpModule
{
    ...
    private void ConfigureObjectMapper()
    {
        ...
        {
            options.AddMaps<MicroAppStudio01AuditLoggingServiceModule>(validate: true);
        });
    }
    ...
    private void ConfigureAutoControllers()
    {
        Configure<AbpAspNetCoreMvcOptions>(options =>
        {
            options
                ...
                .Create(typeof(MicroAppStudio01AuditLoggingServiceModule).Assembly, opts =>
                {
                    opts.RemoteServiceName = "AuditLoggingService";
                    opts.RootPath = "auditloggingservice";
