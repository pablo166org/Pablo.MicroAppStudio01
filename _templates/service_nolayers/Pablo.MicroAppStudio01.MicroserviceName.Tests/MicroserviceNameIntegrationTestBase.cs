...
public abstract class MicroserviceNameIntegrationTestBase : AbpAspNetCoreIntegratedTestBase<MicroserviceNameTestsModule>
{
    ...
    {
        var assemblyDirectoryPath = Path.GetDirectoryName(typeof(MicroAppStudio01MicroserviceNameModule).Assembly.Location);
        if (assemblyDirectoryPath == null)
        {
            throw new Exception($"Could not find location of {typeof(MicroAppStudio01MicroserviceNameModule).Assembly.FullName} assembly!");
        }
