...
helm upgrade --install ${FinalReleaseName} ${ChartName} --namespace ${Namespace} --create-namespace --set global.dotnetEnvironment=${DotnetEnvironment} -f "microappstudio01/values.localdev.yaml" -f "$ChartName/values.${ReleaseName}.yaml"