...
```
127.0.0.1 microappstudio01-local-web
127.0.0.1 microappstudio01-local-webgateway
127.0.0.1 microappstudio01-local-authserver
```
...
Now, you can browse the URL: `https://microappstudio01-local-web`
